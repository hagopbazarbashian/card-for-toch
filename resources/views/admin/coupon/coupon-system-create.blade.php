...
<div class="vh-100" style="background-color: black; background-size: cover; background-repeat: no-repeat; position: relative; min-height: 500px;">
    <a href="{{route('coupon.index') }}"><button class="btn btn-primary">Show All</button></a>
    <div class="container">
        <div class="row justify-content-center align-items-center height-self-center vh-100">
            <div class="col-lg-8 col-md-12 align-self-center">
                <form action="{{route('coupon.store')}}" method="post" id="createForm">
                    @csrf
                    <div class="user-login-card bg-body">
                        <div class="row row-cols-1 row-cols-lg-2 g-2 g-lg-5">
                            <div class="col">
                                <label class="text-white fw-500 mb-2">Rate</label>
                                <input type="text" name="rate" class="form-control rounded-0" placeholder="How many percent you need to send ?" value="{{ old('rate') }}" />
                            </div>
                        </div>
