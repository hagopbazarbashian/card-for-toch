          ...
          <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
             ...
             <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('shop-slider.index') ? 'active' : '' }}" href="{{route('shop-slider.index')}}">
                   <i class="icon" data-bs-toggle="tooltip" title="Movie List" data-bs-placement="right" aria-label="Movie List" data-bs-original-title="Movie List">
            ...
            <li class="nav-item">
             ...
             {{-- <li class="nav-item">
                <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-auth" role="button" aria-expanded="false" aria-controls="sidebar-auth">
                   <i class="icon" data-bs-toggle="tooltip" title="Authentication" data-bs-placement="right" aria-label="Authentication" data-bs-original-title="Authentication">
                ...
                <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/auth/sign-in.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Login" data-bs-placement="right" aria-label="Login" data-bs-original-title="Login">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/auth/sign-up.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Register" data-bs-placement="right" aria-label="Register" data-bs-original-title="Register">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/auth/recoverpw.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Recover Password" data-bs-placement="right" aria-label="Recover Password" data-bs-original-title="Recover Password">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/auth/confirm-mail.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Confirm Mail" data-bs-placement="right" aria-label="Confirm Mail" data-bs-original-title="Confirm Mail">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/auth/two-factor.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Two Factor Authentication" data-bs-placement="right" aria-label="Two Factor Authentication" data-bs-original-title="Two Factor Authentication">
                            <i class="fa-solid fa-fingerprint"></i>
                         </i>
                         <span class="item-name">Two Factor Authentication</span>
                      </a>
                   </li>
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/auth/account-deactivate.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Account Deactivate" data-bs-placement="right" aria-label="Account Deactivate" data-bs-original-title="Account Deactivate">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/auth/lock-screen.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Lock Screen" data-bs-placement="right" aria-label="Lock Screen" data-bs-original-title="Lock Screen">
             ...
             {{-- <li class="nav-item">
                <a class="nav-link" data-bs-toggle="collapse" href="#utilities-error" role="button" aria-expanded="false" aria-controls="utilities-error">
                   <i class="icon" data-bs-toggle="tooltip" title="Utilities" data-bs-placement="right" aria-label="Utilities" data-bs-original-title="Utilities">
                      <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                         <path
                            opacity="0.4"
                ...
                <ul class="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar-menu">
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/errors/error404.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Error 404" data-bs-placement="right" aria-label="Error 404" data-bs-original-title="Error 404">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/errors/error500.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Error 500" data-bs-placement="right" aria-label="Error 500" data-bs-original-title="Error 500">
                            <i class="fa-solid fa-circle-exclamation"> </i>
                         </i>
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/errors/maintenance.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Maintenance" data-bs-placement="right" aria-label="Maintenance" data-bs-original-title="Maintenance">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/errors/coming-soon.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Coming Soon" data-bs-placement="right" aria-label="Coming Soon" data-bs-original-title="Coming Soon">
             ...
             {{-- <li class="nav-item">
                <a class="nav-link" href="../dashboard/blank-page.html">
                   <i class="icon" data-bs-toggle="tooltip" title="Blank Page" data-bs-placement="right" aria-label="Blank Page" data-bs-original-title="Blank Page">
             ...
             {{-- <li class="nav-item">
                <a class="nav-link" data-bs-toggle="collapse" href="#ui" role="button" aria-expanded="false" aria-controls="utilities-error">
                   <i class="icon" data-bs-toggle="tooltip" title="UI Elements" data-bs-placement="right" aria-label="UI Elements" data-bs-original-title="UI Elements">
                      <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                         <path
                            opacity="0.4"
                ...
                <ul class="sub-nav collapse" id="ui" data-parent="#sidebar-menu">
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-avatars.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Avatars" data-bs-placement="right" aria-label="Avatars" data-bs-original-title="Avatars">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-alerts.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Alerts" data-bs-placement="right" aria-label="Alerts" data-bs-original-title="Alerts">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-badges.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Badges" data-bs-placement="right" aria-label="Badges" data-bs-original-title="Badges">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-breadcrumb.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Breadcrumb" data-bs-placement="right" aria-label="Breadcrumb" data-bs-original-title="Breadcrumb">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-buttons.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Buttons" data-bs-placement="right" aria-label="Buttons" data-bs-original-title="Buttons">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-buttons-group.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Button Group" data-bs-placement="right" aria-label="Button Group" data-bs-original-title="Button Group">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-offcanvas.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Offcanvas" data-bs-placement="right" aria-label="Offcanvas" data-bs-original-title="Offcanvas">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-color.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Colors" data-bs-placement="right" aria-label="Colors" data-bs-original-title="Colors">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-cards.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Cards" data-bs-placement="right" aria-label="Cards" data-bs-original-title="Cards">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-carousel.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Carousel" data-bs-placement="right" aria-label="Carousel" data-bs-original-title="Carousel">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-grid.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Grid" data-bs-placement="right" aria-label="Grid" data-bs-original-title="Grid">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-images.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Images" data-bs-placement="right" aria-label="Images" data-bs-original-title="Images">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-list-group.html">
                         <i class="icon" data-bs-toggle="tooltip" title="List Group" data-bs-placement="right" aria-label="List Group" data-bs-original-title="List Group">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-modal.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Modal" data-bs-placement="right" aria-label="Modal" data-bs-original-title="Modal">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-notifications.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Notifications" data-bs-placement="right" aria-label="Notifications" data-bs-original-title="Notifications">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-pagination.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Pagination" data-bs-placement="right" aria-label="Pagination" data-bs-original-title="Pagination">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-popovers.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Popovers" data-bs-placement="right" aria-label="Popovers" data-bs-original-title="Popovers">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-typography.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Typography" data-bs-placement="right" aria-label="Typography" data-bs-original-title="Typography">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-tabs.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Tabs" data-bs-placement="right" aria-label="Tabs" data-bs-original-title="Tabs">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-tooltips.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Tooltips" data-bs-placement="right" aria-label="Tooltips" data-bs-original-title="Tooltips">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/ui-elements/ui-embed-video.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Video" data-bs-placement="right" aria-label="Video" data-bs-original-title="Video">
             ...
             {{-- <li class="nav-item">
                <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-widget" role="button" aria-expanded="false" aria-controls="sidebar-widget">
                   <i class="icon" data-bs-toggle="tooltip" title="Widgets" data-bs-placement="right" aria-label="Widgets" data-bs-original-title="Widgets">
                      <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                         <path
                            opacity="0.4"
                ...
                <ul class="sub-nav collapse" id="sidebar-widget" data-bs-parent="#sidebar-menu">
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/widget/widgetbasic.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Widget Basic" data-bs-placement="right" aria-label="Widget Basic" data-bs-original-title="Widget Basic">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/widget/widgetchart.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Widget Chart" data-bs-placement="right" aria-label="Widget Chart" data-bs-original-title="Widget Chart">
                            <i class="fa-regular fa-square-full"></i>
                         </i>
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/widget/widgetcard.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Widget Card" data-bs-placement="right" aria-label="Widget Card" data-bs-original-title="Widget Card">
                            <i class="fa-regular fa-square-full"></i>
                         </i>
             ...
             {{-- <li class="nav-item">
                <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-form" role="button" aria-expanded="false" aria-controls="sidebar-form">
                   <i class="icon" data-bs-toggle="tooltip" title="Form" data-bs-placement="right" aria-label="Form" data-bs-original-title="Form">
                      <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <ul class="sub-nav collapse" id="sidebar-form" data-bs-parent="#sidebar-menu">
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/form/form-element.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Elements" data-bs-placement="right" aria-label="Elements" data-bs-original-title="Elements">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/form/form-wizard.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Wizard" data-bs-placement="right" aria-label="Wizard" data-bs-original-title="Wizard">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/form/form-validation.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Validation" data-bs-placement="right" aria-label="Validation" data-bs-original-title="Validation">
             ...
             {{-- <li class="nav-item">
                <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-table" role="button" aria-expanded="false" aria-controls="sidebar-table">
                   <i class="icon" data-bs-toggle="tooltip" title="Table" data-bs-placement="right" aria-label="Table" data-bs-original-title="Table">
                ...
                <ul class="sub-nav collapse" id="sidebar-table" data-bs-parent="#sidebar-menu">
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/table/bootstrap-table.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Bootstrap Table" data-bs-placement="right" aria-label="Bootstrap Table" data-bs-original-title="Bootstrap Table">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/table/table-data.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Datatable" data-bs-placement="right" aria-label="Datatable" data-bs-original-title="Datatable">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/table/border-table.html">
                         <i class="icon" data-bs-toggle="tooltip" title="Bordered Table" data-bs-placement="right" aria-label="Bordered Table" data-bs-original-title="Bordered Table">
                            <i class="fa-solid fa-table-list"></i>
                         </i>
                   ...
                   <li class="nav-item">
                      <a class="nav-link" href="../dashboard/table/fixed-table.html">
                         <i class="icon" data-bs-toggle="tooltip" title="FixedTable" data-bs-placement="right" aria-label="Fixed Tabl" data-bs-original-title="Fixed Tabl">
             ...
             {{-- <li class="nav-item mb-4">
                <a class="nav-link" href="../dashboard/icons/font-awesome.html">
                   <i class="icon" data-bs-toggle="tooltip" title="Icons" data-bs-placement="right" aria-label="Icons" data-bs-original-title="Icons">
                      <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                         <path
                            opacity="0.4"
