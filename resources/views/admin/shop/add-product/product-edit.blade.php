...
<div class="vh-100" style="background-color: black; background-size: cover; background-repeat: no-repeat; position: relative; min-height: 500px;">
    <a href="{{route('add-new-card.index') }}"><button class="btn btn-primary">Show All</button></a>
    <div class="container">
                    ...
                    <div class="user-login-card bg-body">
                        <div class="row row-cols-1 row-cols-lg-2 g-2 g-lg-5">
                            ...
                            <div class="col">
                                ...
                                <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="3">{{$newproduct->description}}</textarea>
                            </div>
                            <div class="col">
                                <label class="text-white fw-500 mb-2">Price</label>
                                <input type="number" name="price" class="form-control rounded-0" value="{{$newproduct->price}}" />
                            </div>
                            <div class="col">
                                <label class="text-white fw-500 mb-2">Discount</label>
                                <input type="number" name="discount" class="form-control rounded-0" value="{{$newproduct->discount}}" />
                            </div>
                        </div>
